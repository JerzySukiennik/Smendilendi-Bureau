...
export const COMPUTER_TIERS = [
  {
    ...
    undo: 8, previewFps: 12, daylightPreview: false, bootSound: 'os.boot-tier1',
  ...
  },
  {
    ...
    undo: 24, previewFps: 24, daylightPreview: false, bootSound: 'os.boot-tier2',
  ...
  },
  {
    ...
    undo: 80, previewFps: 45, daylightPreview: true, bootSound: 'os.boot-tier3',
  ...
  },
  {
    ...
    undo: 250, previewFps: 60, daylightPreview: true, bootSound: 'os.boot-tier4',
