...
// --- 16x16 -----------------------------------------------------------------
//
// Round 2 rewrite. The 32x32 desktop set was already redrawn as 4-bit isometric
// art, but these were not, and in a blind A/B against win95-09 the 16x16 in the
// TITLE BAR was the one region a reader could pick out in under a second: ours
// were sparse outline-and-fill glyphs where Windows ships dense hand-dithered
// 4-bit art. Two measurements set the bar, both taken off win95-14's taskbar
// with a run scanner:
//
//   * the Control Panel icon (x=62..81, y=5..24) samples NINE distinct colours
//     — #FFFFFF 124 px, #C0C0C0 114, #808080 75, #000000 35, #FFFF00 26,
//     #DFDFDF 20, #0000FF 2, #FF0000 2, #800000 2. Ours sampled FOUR over the
//     same 20x20 patch: #C0C0C0 219, #FFFFFF 91, #000000 70, #DFDFDF 20.
//   * that icon's folder face is not flat yellow. It is a 1 px checkerboard of
//     #FFFF00 over #FFFFFF — the hand-dithered highlight checklist item 17 asks
//     for, done at 16 px with alternating characters in the art below.
//
// So every glyph here now carries: a hard dark outline, a lit top face with a
// 1 px dither along it, a #808080 shadow cheek down the right, and three or
// four accent hues out of the VGA sixteen. Nothing is anti-aliased — the art is
// a character grid, one character per pixel.

export const I16 = {
  // A sealed envelope seen slightly from above: a dithered lit top edge, a
  // staircase flap creased in grey, a maroon wax seal, and an airmail dash
  // band. Round 1's was a white rectangle, a black outline and a V.
  mail: art16([
    '................',
    '................',
    '.kkkkkkkkkkkkk..',
  ...
  // The same envelope with its flap folded back and standing open. The inside
  // of the flap is a #FFFFFF / #DFDFDF checkerboard, which is how a 4-bit icon
  // says "lighter than the body" without inventing a colour off the palette.
  mailOpen: art16([
    '................',
    '.......kk.......',
    '......kwlk......',
  ...
  // Two terminals on a wire — the period metaphor for talking to other
  // machines. Each is a bevelled box with a dithered lit top, a navy screen
  // with an aqua text line, a silver cheek and a grey shadow cheek.
  chat: art16([
    '................',
    '.kkkkkkk........',
    '.kwlwlwk........',
  ...
  // The cost sheet: a clipboard with a dithered chrome clip, a priced sheet
  // ruled in two tones, and a green total struck off at the foot. Not a bar
  // chart, not a "chart" glyph.
  cost: art16([
    '......kkkk......',
    '.kkkkkwlwkkkkkk.',
    '.kwlwlgggwlwlwk.',
  ...
  // Manila folder, closed, with a block of white paper standing in it. The
  // lighter yellow along the lit edge is NOT a fifth yellow — #FFFF80 is off
  // the 16-colour palette (checklist 14), so a real 4-bit icon fakes it with a
  // 1 px checkerboard of white over yellow, exactly as win95-14's folder does.
  folder: art16([
    '................',
    '..kkkkk.........',
    '..kywkkkkkkkkkk.',
  ...
  // The same folder with its front leaf tipped forward: it is wider than the
  // body behind it, and the block of paper is the whole face.
  folderOpen: art16([
    '................',
    '..kkkkk.........',
    '..kywkkkkkkkkkk.',
  ...
  // The Design app: a CRT with a floor plan on the glass — navy walls, white
  // rooms, the way a plan is actually drawn — a dithered bezel top, a grey
  // shadow cheek, a lime power lamp, and a dithered base.
  design: art16([
    '................',
    '.kkkkkkkkkkkkkk.',
    '.klwlwlwlwlwlgk.',
  ...
  // Control Panel: a manila folder with a bevelled panel of coloured controls
  // sitting in it — the exact construction of win95-14's own Control Panel
  // icon, which a run scan of the taskbar at x=62..81, y=5..24 shows to be
  // NINE colours (#FFFFFF #C0C0C0 #808080 #000000 #FFFF00 #DFDFDF #0000FF
  // #FF0000 #800000) over a checkerboarded yellow face. Never a gear
  // (checklist 18). Round 2's sliders read as ruled paper at 16 px.
  settings: art16([
    '................',
    '..kkkk..........',
    '..kywkkkkkkkkk..',
  ...
  // 3.5-inch floppy: a navy shell dithered blue along the lit top, a silver
  // shutter with its own bevel, and a white label ruled in grey. Save.
  floppy: art16([
    '................',
    '..kkkkkkkkkkkk..',
    '..knbnbnbnbngk..',
  ...
  // Text document: a sheet with the top-right corner turned over, a navy
  // heading and two-tone ruled lines. The fold is a silver step, not a flat
  // triangle — Win95 never leaves a fold unshaded.
  doc: art16([
    '................',
    '...kkkkkkkk.....',
    '...kwlwlwksk....',
  ...
  // The machine itself: a CRT with a dithered bezel, a teal screen carrying a
  // plan, a lime power lamp, a neck and a dithered base.
  computer: art16([
    '................',
    '.kkkkkkkkkkkk...',
    '.klwlwlwlwlgk...',
  ...
  // Waste basket: a hard elliptical rim, a dark interior, ribs, and a 1 px
  // checkerboard where the lit side rolls into the shadow cheek.
  bin: art16([
    '................',
    '....kkkkkkkk....',
    '...kwlwlwlwlk...',
  ...
  // and in the Apple position on the Platinum tiers. The face is a 1 px
  // #DFDFDF / #C0C0C0 weave, not a smooth ramp.
  square: art16([
    '................',
    '................',
    '...........k....',
  ...
  // Printer with fanfold paper going in above and coming out below, a dithered
  // case top, a sunken paper slot and a red ready lamp.
  printer: art16([
    '................',
    '....kkkkkkkk....',
    '....kwlwlwlk....',
  ...
  // A desk telephone in 3/4 — the modem, and the client on the line. A handset
  // resting across the top, a dithered lit case top, a dial with a red mark and
  // a grey shadow cheek. Round 2 drew a bare handset and it read as a bracket.
  phone: art16([
    '................',
    '................',
    '..kkkkkkkkkk....',
  ...
  // A stopped clock — the deadline. A dithered silver rim around a white face,
  // black hands, and a grey shadow down the lower right.
  clock: art16([
    '................',
    '.....kkkkk......',
    '...kkslslskk....',
  ...
  // The message-box warning triangle: a yellow lit face, an olive shadow cheek
  // and a white dither down the lit edge.
  warning: art16([
    '................',
    '.......kk.......',
    '......kyok......',
  ...
  // The circled lower-case i. Windows uses this for message-box severity and
  // nowhere else — the Start menu's Help row is a book (see ICON32.help).
  info: art16([
    '................',
    '.....kkkkk......',
    '...kkbnbnbkk....',
  ...
  // Find: a chrome magnifier lying across a manila folder, its handle running
  // off the folder's bottom-right corner. Round 1 pointed the Start menu's
  // "Find" at the plain document glyph, so Documents and Find were the same
  // white page — the one thing that gave that menu away in a blind A/B.
  find: art16([
    '................',
    '.kkkk...........',
    '.kywkkkkkkkk....',
  ...
  // A closed book with a question mark, at 16 px, for menu rows that are not
  // 32 px tall. Same metaphor as ICON32.help, and the same purple cover
  // win95-05 gives its own Help row.
  help: art16([
    '................',
    '...kkkkkkkkkkk..',
    '...kpfpfpkwlwk..',
